 ...
 * @author Admin
 */
public class AccouplementCCController implements Initializable {
    ...
    @FXML
    private TextField Recherche_accouplement_txt;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
      ...
      Recherche_accouplement_txt.setVisible(true);
    ...
    combochoix.getSelectionModel().selectedIndexProperty().addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                //liste2.refresh();
                Recherche_accouplement_txt.setText("");
                switch (combochoix.getSelectionModel().getSelectedIndex()) {
                    ...
                    case 1:
                        ...
                        Recherche_accouplement_txt.setVisible(false);
       ...
       Recherche_accouplement_txt.textProperty().addListener(new ChangeListener() {
            @Override
    ...
    @FXML
    private void PosterAnnonce(ActionEvent event) {
...
if (result.get() == buttonTypeOne){
    ...
    private void AfficherA(){
        ...
        liste2.getSelectionModel().setSelectionMode(SelectionMode.MULTIPLE);
          ObservableList<Annonce> lp = a.getAllAnnoncesAccouplement();
    ...
    @FXML
    private void onSelectAccouplement(MouseEvent event) throws IOException {
...
//               LoggedAnimal.setId_animal(s.getId_animal2());
         ...
         Anchor3.getChildren().clear();
            Pane newLoadedPane = FXMLLoader.load(getClass().getResource("ProfilpropAnnonceAccouplement.fxml"));
            Anchor3.getChildren().add(newLoadedPane);
    ...
    //***************************************************************
        ...
        if (choix.equals("RaceAnimal")) {
            ...
            if (Recherche_accouplement_txt.getText() == null || newValue == null) {
                liste2.setItems(a.getAllAnnoncesAccouplement());
            } else {
                liste2.setItems(a.getAllAnnoncesAccouplement());
            ...
            ObservableList<Annonce> filteredList = FXCollections.observableArrayList();
            if ( Recherche_accouplement_txt.getText()== null || newValue == "") {
                liste2.setItems(a.getAllAnnoncesAccouplement());
            } else {
                liste2.setItems(a.getAllAnnoncesAccouplement());
    ...
    private void comboRechercheSexe(ActionEvent event) {
         Recherche_accouplement_txt.setText(comboSexe.getValue());
    }
