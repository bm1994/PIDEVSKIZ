 ...
 * @author Admin
 */
public class ProfilpropAnnonceAccouplementController implements Initializable {
...
Animal u=an.search(AccouplementCCController.LoggedUser.getId_animal());
...
User ur=us.findById(u.getId_Utilisateur().getId_utilisateur());
    ...
    @FXML
    private void contacterparSms(ActionEvent event) {
...
User ur=us.findById(u.getId_Utilisateur().getId_utilisateur());
   ...
   Message message = Message.creator(new PhoneNumber("+21692417135"), new PhoneNumber("+18447415160"),"  Mr/Mme    "+ur.getPrenom()+"   Mr/Mme     "+Session.LoggedUser.getPrenom()+"veut vous contacter a propos de votre annonce d'accouplement si vous voulez le contacter son numero de telephone est "+Session.LoggedUser.getTelephone()).create();
