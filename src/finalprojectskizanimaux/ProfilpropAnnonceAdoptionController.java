 ...
 * @author Admin
 */
public class ProfilpropAnnonceAdoptionController implements Initializable {
...
Animal u=an.search(AdoptionCCController.LoggedUser.getId_animal());
...
User ur=us.findById(u.getId_Utilisateur().getId_utilisateur());
   ...
   Message message = Message.creator(new PhoneNumber("+21692417135"), new PhoneNumber("+18447415160"),"  Mr/Mme    "+ur.getPrenom()+"   Mr/Mme     "+Session.LoggedUser.getPrenom()+"    veut vous contacter a propos de votre annonce d'Adoption Si vous voulez le contacter Son Numero de telephone est  "+Session.LoggedUser.getTelephone()).create();
